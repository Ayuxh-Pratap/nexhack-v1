      ...
      <div className="flex flex-col lg:w-6/12 md:w-9/12 sm:w-full md:justify-center">
        ...
        {cameraState === CameraState.READY ? (
          <div className="relative">
            ...
            />
            <div
              className={`rounded-md border-solid border-2 ${confirmLetter ? "border-green-500" : "border-black"
                } absolute top-0 right-0 w-3/12 h-1/4 flex items-center justify-center`}
            >
              {handActive && (
                <span
                  className={`${confirmLetter ? "text-green-500" : "text-black"
                    } text-2xl`}
                >
                  {letter}
                </span>
        ...
        <div className="grid grid-cols-4 gap-auto place-items-center mt-2 mb-2">
          ...
          <Modal
            ...
            title=""
            children={<img className="flex m-auto" src={ASLAlphabet.src}></img>}
          />
